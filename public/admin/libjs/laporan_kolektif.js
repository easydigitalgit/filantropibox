var nama_module = 'laporan_kolektif';
var label_module = 'Laporan Kolektif';
...
form_element['input'] = ['#id', '#id_canvaser', '#id_box', '#jumlah_kolektif', '#tanggal_kolektif', '#keterangan'];
form_element['select'] = [];
...
$(document).ready(function () {
    loadTableLaporanKolektif(table);
});

function loadTableLaporanKolektif(table) {
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.status) {
                ...
                $(form_element['input'][1]).val(res.data.id_canvaser);
                $(form_element['input'][2]).val(res.data.id_box);
                $(form_element['input'][3]).val(res.data.jumlah_kolektif);
                $(form_element['input'][4]).val(res.data.tanggal_kolektif);
                $(form_element['input'][5]).val(res.data.keterangan);
